...
/**
 * A dummy transaction class that only supports checking/setting active/blocked status. Used for
 * testing locking code without requiring an instance of the database.
 */
public class DummyTransactionContext extends AbstractTransactionContext {
  ...
  public BacktrackingIterator<Record> getBlockIterator(String tableName, Page[] block) {
    throw new UnsupportedOperationException("dummy transaction cannot do this");
  }

  public BacktrackingIterator<Record> getBlockIterator(
      String tableName, BacktrackingIterator<Page> block) {
    throw new UnsupportedOperationException("dummy transaction cannot do this");
  }
