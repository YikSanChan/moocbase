...
public class TestLockUtil {
  ...
  public void testIStoS() {
    ...
    assertEquals(
        Collections.singletonList("acquire-and-release 0 database/table1 S [database/table1]"),
        lockManager.log);
  }
  ...
  public void testIXBeforeIS() {
    ...
    lockManager.startLog();
    LockUtil.ensureSufficientLockHeld(pageContexts[4], LockType.S);
    assertEquals(Collections.singletonList("acquire 0 database/table1/4 S"), lockManager.log);
  }
  ...
  public void testSIX1() {
    ...
    LockUtil.ensureSufficientLockHeld(tableContext, LockType.S);
    assertEquals(
        Collections.singletonList("acquire-and-release 0 database/table1 SIX [database/table1]"),
        lockManager.log);
  }
