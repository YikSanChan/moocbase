...
public class TestBufferManager {
  ...
  public void beforeEach() {
    ...
    bufferManager =
        new BufferManagerImpl(
            diskSpaceManager, new DummyRecoveryManager(), 5, new ClockEvictionPolicy());
  }
  ...
  public void testFlush() {
    ...
    assertArrayEquals(
        new byte[4],
        Arrays.copyOfRange(
            actual, 67 + BufferManager.RESERVED_SPACE, 71 + BufferManager.RESERVED_SPACE));
    ...
    assertArrayEquals(
        new byte[4],
        Arrays.copyOfRange(
            actual, 33 + BufferManager.RESERVED_SPACE, 37 + BufferManager.RESERVED_SPACE));
