...
/**
 * File for student tests for Project 5 (Recovery). Tests are run through TestARIESStudentRunner for
 * grading purposes.
 */
...
public class TestARIESStudent {
  ...
  /**
   * *********************************************************************** Helpers for writing
   * tests. * Do not change the signature of any of the following methods. *
   * ***********************************************************************
   */
