...
// Instrumented version of ARIESRecoveryManager for testing, without locking so that tests pass
// without Proj4.
class ARIESRecoveryManagerNoLocking extends ARIESRecoveryManager {
  long transactionCounter = 0L;

  ARIESRecoveryManagerNoLocking(LockContext dbContext, Function<Long, Transaction> newTransaction) {
