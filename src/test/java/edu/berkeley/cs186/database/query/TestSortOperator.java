...
public class TestSortOperator {
  ...
  public TestRule globalTimeout =
      new DisableOnDebug(Timeout.millis((long) (5000 * TimeoutScaling.factor)));
  ...
  public static class SortRecordComparator implements Comparator<Record> {
    ...
    public int compare(Record o1, Record o2) {
      return o1.getValues().get(this.columnIndex).compareTo(o2.getValues().get(this.columnIndex));
    }
  }
  ...
  public void testSortRun() {
    try (Transaction transaction = d.beginTransaction()) {
      ...
      SortOperator s =
          new SortOperator(
              transaction.getTransactionContext(), "table", new SortRecordComparator(1));
      checkIOs(0);
  ...
  public void testSortNoChange() {
    try (Transaction transaction = d.beginTransaction()) {
      ...
      Iterator<Record> iter =
          transaction.getTransactionContext().getRecordIterator(sortedTableName);
      int i = 0;
      while (iter.hasNext() && i < 400 * 3) {
