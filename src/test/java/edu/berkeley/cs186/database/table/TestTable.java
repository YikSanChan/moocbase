...
public class TestTable {
  ...
  /**
   * Loads some number of pages of records. rids will be loaded with all the record IDs of the new
   * records, and the number of records will be returned.
   */
  ...
  /** See above; this overload should be used when the list of record IDs is not needed. */
  ...
  /**
   * Performs a simple loop checking (end - start)/incr records from iter, and assuming values of
   * recordWithAllTypes(i), where start <= i < end and i increments by incr.
   */
  private void checkSequentialRecords(
      int start, int end, int incr, BacktrackingIterator<Record> iter) {
  ...
  /**
   * Basic test over a half-full page of records, with a missing first/last record and gaps between
   * every record, to check that next/hasNext work.
   */
  @Test
  ...
  /**
   * Basic test making sure that RIDPageIterator handles mark/reset properly, but with gaps between
   * each record.
   */
  @Test
  ...
  /**
   * Extra test making sure that RIDPageIterator handles mark/reset properly, but with gaps between
   * each record.
   */
  @Test
  ...
  /** Simple test of TableIterator over three pages of records with every other record missing. */
  @Test
