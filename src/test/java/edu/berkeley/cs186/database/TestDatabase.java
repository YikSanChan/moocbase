...
public class TestDatabase {
  ...
  public void testREADMESample() {
    try (Transaction t1 = db.beginTransaction()) {
      ...
      t1.insert(
          "table1",
          Arrays.asList(
              new IntDataBox(1), new StringDataBox("John", 10), new StringDataBox("Doe", 10)));
      t1.insert(
          "table1",
          Arrays.asList(
              new IntDataBox(2), new StringDataBox("Jane", 10), new StringDataBox("Doe", 10)));
      t1.commit();
    }
  ...
  public void testJoinQuery() {
    ...
    try (Transaction t2 = db.beginTransaction()) {
      ...
      queryPlan.project(
          Arrays.asList("t1.id", "t2.id", "t1.firstName", "t2.firstName", "t1.lastName"));
  ...
  public void testAggQuery() {
    ...
    try (Transaction t2 = db.beginTransaction()) {
      ...
      assertEquals(
          Arrays.asList(new IntDataBox(2), new IntDataBox(3), new FloatDataBox(1.5f)),
          iter.next().getValues());
  ...
  public void testGroupByQuery() {
    ...
    try (Transaction t2 = db.beginTransaction()) {
      ...
      assertEquals(
          Arrays.asList(new StringDataBox("Doe", 10), new IntDataBox(2)), iter.next().getValues());
  ...
  public void testUpdateQuery() {
    ...
    try (Transaction t2 = db.beginTransaction()) {
      ...
      t2.update(
          "table1",
          "id",
          (DataBox x) -> new IntDataBox(x.getInt() + 10),
          "lastName",
      ...
      assertEquals(
          Arrays.asList(
              new IntDataBox(11), new StringDataBox("John", 10), new StringDataBox("Doe", 10)),
          iter.next().getValues());

      assertEquals(
          Arrays.asList(
              new IntDataBox(12), new StringDataBox("Jane", 10), new StringDataBox("Doe", 10)),
          iter.next().getValues());
