...
public class UpdatePageLogRecord extends LogRecord {
  ...
  public UpdatePageLogRecord(
      long transNum, long pageNum, long prevLSN, short offset, byte[] before, byte[] after) {
  ...
  public Pair<LogRecord, Boolean> undo(long lastLSN) {
    ...
    return new Pair<>(
        new UndoUpdatePageLogRecord(transNum, pageNum, lastLSN, prevLSN, offset, before), false);
  }
