...
public abstract class AbstractTransaction implements Transaction {
  ...
  /**
   * Called when commit() is called. Any exception thrown in this method will cause the transaction
   * to abort.
   */
  protected abstract void startCommit();

  /**
   * Called when rollback() is called. No exception should be thrown, and any exception thrown will
   * be interpreted the same as if the method had returned normally.
   */
   ...
   * <p>try (Transaction t = ...) { ... }
   *
   * <p>and have the transaction commit.
   */
  @Override
