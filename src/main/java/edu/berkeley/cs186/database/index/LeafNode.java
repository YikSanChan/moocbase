 ...
 * connected together:
 *
 * <p>leaf 1 (stored on some page) leaf 2 (stored on some other page)
 * +-------+-------+-------+-------+ +-------+-------+-------+-------+ | k0:r0 | k1:r1 | k2:r2 | |
 * --> | k3:r3 | k4:r4 | | | +-------+-------+-------+-------+ +-------+-------+-------+-------+
 */
class LeafNode extends BPlusNode {
  ...
  /**
   * Returns an iterator over the record ids of this leaf in ascending order of their corresponding
   * keys.
   */
  ...
  /**
   * Returns an iterator over the record ids of this leaf that have a corresponding key greater than
   * or equal to `key`. The record ids are returned in ascending order of their corresponding keys.
   */
  ...
  /**
   * Returns the largest number d such that the serialization of a LeafNode with 2d entries will fit
   * on a single page.
   */
  ...
  public String toString() {
    ...
    return String.format(
        "LeafNode(pageNum=%s, keys=%s, rids=%s, rightSibling=%s)",
   ...
   *
   * <p>node1[label = "{0: (0 0)|1: (1 1)|2: (2 2)}"];
   */
  @Override
  public String toDot() {
    List<String> ss = new ArrayList<>();
  ...
  public static LeafNode fromBytes(
      BPlusTreeMetadata metadata,
      BufferManager bufferManager,
      LockContext treeContext,
      long pageNum) {
