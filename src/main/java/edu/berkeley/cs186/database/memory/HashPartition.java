...
public class HashPartition {
  ...
  /**
   * A class representing a partition used in hashing operations for grace hash join. This partition
   * supports adding and iterating over records for two different relations.
   *
   * @param transaction the transaction context this buffer will be used in
   * @param leftSchema the schema for the type of records in the left table to be added to this
   *     partition
   * @param rightSchema the schema for the type of records in the right table to be added to this
   *     partition
   */
  ...
  /**
   * Returns the number of pages used to store records from the left relation in this partition
   *
  ...
  /**
   * Returns the number of pages used to store records from the right relation in this partition
   *
  ...
  /**
   * Returns an iterator over all of the records from the left relation that were written to this
   * partition
   *
  ...
  /**
   * Returns an iterator over all of the records from the right relation that were written to this
   * partition
   *
   * @return an iterator over all the records in this partition
   */
