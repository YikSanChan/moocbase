...
/**
 * Implementation of LRU eviction policy, which works by creating a doubly-linked list between
 * frames in order of ascending use time.
 */
public class LRUEvictionPolicy implements EvictionPolicy {
  ...
  /**
   * Called when a frame is removed, either because it was returned from a call to evict, or because
   * of other constraints (e.g. if the page is deleted on disk).
   *
