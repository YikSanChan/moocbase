...
public class ExampleLoader {
  public static Database setupDatabase() throws IOException {
    ...
    // Database database = new Database("demo", 25, new LockManager(), new ClockEvictionPolicy(),
    // true);
    ...
    try (Transaction transaction = database.beginTransaction()) {
      ...
      List<String> studentLines =
          Files.readAllLines(Paths.get("data", "Students.csv"), Charset.defaultCharset());
      ...
      List<String> courseLines =
          Files.readAllLines(Paths.get("data", "Courses.csv"), Charset.defaultCharset());
      ...
      List<String> enrollmentLines =
          Files.readAllLines(Paths.get("data", "Enrollments.csv"), Charset.defaultCharset());
