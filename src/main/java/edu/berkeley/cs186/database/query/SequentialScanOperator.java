...
class SequentialScanOperator extends QueryOperator {
   ...
   *
   * <p>NOTE: Sequential scans don't take a source operator because they must always be at the
   * bottom of the DAG.
   *
   * @param transaction
   * @param tableName
  ...
  protected SequentialScanOperator(
      OperatorType type, TransactionContext transaction, String tableName) {
    super(type);
