...
class SelectOperator extends QueryOperator {
   ...
   */
  SelectOperator(
      QueryOperator source, String columnName, PredicateOperator operator, DataBox value) {
  ...
  public TableStats estimateStats() {
    ...
    return stats.copyWithPredicate(this.columnIndex, this.operator, this.value);
  }
