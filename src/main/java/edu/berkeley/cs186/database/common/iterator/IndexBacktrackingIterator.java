...
/**
 * Partial implementation of a backtracking iterator over an indexable collection with some indices
 * possibly not matching to a value.
 */
public abstract class IndexBacktrackingIterator<T> implements BacktrackingIterator<T> {
  ...
  /**
   * Get the value at the given index. Index will always be a value returned by getNextNonempty.
   *
