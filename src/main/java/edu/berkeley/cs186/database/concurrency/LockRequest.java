...
/**
 * Represents a lock request on the queue, for TRANSACTION requesting LOCK and releasing everything
 * in RELEASEDLOCKS. LOCK should be granted and everything in RELEASEDLOCKS should be released
