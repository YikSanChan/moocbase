 ...
 *
 * <p>1. A bounded bucket `new Bucket<T>(start, stop)` represents a count of values in the range
 * [start, stop). 2. An unbounded bucket `new Bucket<T>(start)` represents a count of values in the
...
public class Bucket<T> {
  ...
  public boolean equals(Object o) {
    ...
    boolean endEquals =
        (end == null && b.end == null) || (end != null && b.end != null && end.equals(b.end));
