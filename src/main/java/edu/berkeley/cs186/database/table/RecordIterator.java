...
/**
 * A RecordIterator wraps an Iterator<RecordId> to form an BacktrackingIterator<Record>. For
 * example,
 *
 * <p>Iterator<RecordId> ridIterator = t.ridIterator(); RecordIterator recordIterator = new
 * RecordIterator(t, ridIterator); recordIterator.next(); // equivalent to
 * t.getRecord(ridIterator.next()) recordIterator.next(); // equivalent to
 * t.getRecord(ridIterator.next()) recordIterator.next(); // equivalent to
 * t.getRecord(ridIterator.next())
 */
